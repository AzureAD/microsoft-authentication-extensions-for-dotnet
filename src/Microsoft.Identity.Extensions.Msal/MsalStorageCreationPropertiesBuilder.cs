...
{
    /// <summary>
    /// An incremental builder for <see cref="MsalStorageCreationProperties"/> objects.
    /// </summary>
    public class MsalStorageCreationPropertiesBuilder
    {
        ...
        public MsalStorageCreationPropertiesBuilder(string cacheFileName, string cacheDirectory)
        {
        ...
        /// <summary>
        /// Returns an immutable instance of <see cref="MsalStorageCreationProperties"/> matching the configuration of this builder.
        /// </summary>
        /// <returns>An immutable instance of <see cref="MsalStorageCreationProperties"/> matching the configuration of this builder.</returns>
        ...
        public MsalStorageCreationPropertiesBuilder WithMacKeyChain(string serviceName, string accountName)
        {
        ...
        /// <returns>The augmented builder</returns>
        public MsalStorageCreationPropertiesBuilder WithLinuxKeyring(
            string schemaName,
            string collection,
            string secretLabel,
