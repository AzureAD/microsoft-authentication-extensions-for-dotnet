...
namespace Microsoft.Identity.Extensions.Adal
{
    ...
    public sealed class AdalCacheStorage
    {
        ...
        public AdalCacheStorage(AdalStorageCreationProperties creationProperties, string cacheFilePath, string instanceName, TraceSource logger)
        {
            ...
            logger.TraceEvent(TraceEventType.Information, /*id*/ 0, FormattableString.Invariant($"Initializing '{nameof(AdalCacheStorage)}' with cacheFilePath '{cacheFilePath}' and instance name '{instanceName}"));
            ...
            if (string.IsNullOrWhiteSpace(cacheFilePath))
            {
                try
                {
                    ...
                    CacheFilePath = Path.Combine(localDataPath, basepath, _creationProperties.ADALCacheFileName);
